      ...
      <Container className="py-6">
        <header className="text-center mb-8">
          <div className="flex items-center justify-center gap-3 mb-2">
            <div className="h-8 w-8 rounded-full bg-kid-blue text-white flex items-center justify-center text-xl">
              🌍
            </div>
            <h1 className="text-3xl font-bold text-kid-blue">GeoChatBot for Kids</h1>
          </div>
        ...
        <div className="grid md:grid-cols-3 gap-6">
          <div className="md:col-span-2 flex flex-col">
            <div className="bg-white rounded-2xl shadow-md p-4 mb-4 flex-1 overflow-hidden flex flex-col">
                ...
                <div className="mt-4 flex flex-wrap gap-2">
                  {presetQuestions.map((question, index) => (
                    <button
                      ...
                      disabled={isLoading}
                      className="bg-kid-blue/10 hover:bg-kid-blue/20 text-kid-blue text-sm rounded-full px-3 py-1"
                    >
                      {question}
                    </button>
                  ))}
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="bg-white rounded-2xl shadow-md p-4">
              <h3 className="text-kid-blue font-bold mb-2">Fun Geography Facts!</h3>
        ...
        <footer className="mt-12 text-center text-xs text-gray-500">
          <p>GeoChatBot for Kids © 2025 | Learning about our amazing planet!</p>
        </footer>
      </Container>
    </div>
  );
